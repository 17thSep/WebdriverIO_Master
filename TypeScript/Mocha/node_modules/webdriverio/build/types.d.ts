...
export declare type MultiRemoteElement<T extends 'sync' | 'async'> = T extends 'sync' ? MultiRemoteElementReferenceSync & MultiRemoteElementSync : MultiRemoteElementReferenceAsync & MultiRemoteElementAsync;

...
function toBeRequestedWithFn(received, requestedWith = {}, options = {}) {
    ...
    return browser.call(async () => {
        ...
        const message = utils_1.enhanceError('mock', minifyRequestedWith(requestedWith), minifyRequestMock(actual, requestedWith) || 'was not called', this, verb, expectation, '', options);
        return {
            pass,
            message: () => message,
        };
...
const urlMatcher = (url, expected) => {
    ...
    return jasmineUtils_1.equals(url, expected);
};
const headersMatcher = (headers, expected) => {
    ...
    return jasmineUtils_1.equals(headers, expected);
};
const bodyMatcher = (body, expected) => {
    ...
    return jasmineUtils_1.equals(parsedBody, expected);
};

...
export declare const builder: (yargs: yargs.Argv<{}>) => yargs.Argv<yargs.Omit<{}, "framework" | "reporters" | "hostname" | "port" | "path" | "baseUrl" | "spec" | "user" | "key" | "logLevel" | "waitforTimeout" | "watch" | "bail" | "suite" | "exclude" | "mochaOpts" | "jasmineNodeOpts" | "cucumberOpts" | "autoCompileOpts"> & yargs.InferredOptionTypes<{
    readonly watch: {
        readonly desc: "Run WebdriverIO in watch mode";
        readonly type: "boolean";
    };

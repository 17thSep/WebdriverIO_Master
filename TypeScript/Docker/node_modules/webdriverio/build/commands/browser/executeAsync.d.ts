 ...
 *
 */
export default function executeAsync<T, U extends any[]>(this: WebdriverIO.Browser | WebdriverIO.Element, script: string | ((...args: [...innerArgs: U, callback: (result: T) => void]) => void), ...args: U): Promise<T>;

    ...
    var _loop_1 = function (file) {
        if (file.match(/\.feature$/)) {
            it("can render " + file, function () { return __awaiter(void 0, void 0, void 0, function () {
                var dom, document, supportCode, p, gherkinStream, gherkinQuery, cucumberQuery, envelopesQuery, cucumberQueryStream, app;
                return __generator(this, function (_a) {
                    switch (_a.label) {
                        case 0:
                            dom = new jsdom_1.JSDOM('<html lang="en"><body><div id="content"></div></body></html>');
                            // @ts-ignore
                            global.window = dom.window;
                            document = dom.window.document;
                            supportCode = new fake_cucumber_1.SupportCode();
                            p = path_1.default.join(dir, file);
                            gherkinStream = gherkin_1.GherkinStreams.fromPaths([p], {
                            ...
                            envelopesQuery = new src_1.EnvelopesQuery();
                        ...
                        case 1:
                            _a.sent();
                            app = (react_1.default.createElement(src_1.QueriesWrapper, { gherkinQuery: gherkinQuery, cucumberQuery: cucumberQuery, envelopesQuery: envelopesQuery },
                                react_1.default.createElement(GherkinDocumentList_1.default, { gherkinDocuments: gherkinQuery.getGherkinDocuments() })));

 ...
 * @param {*} results
 */
export declare function runOnCompleteHook(onCompleteHook: Function | Function[], config: Options.Testrunner, capabilities: Capabilities.Capabilities, exitCode: number, results: OnCompleteResult): Promise<(0 | 1)[]>;
/**
